...
const {createaccounts, Getallaccounts,getoneaccount,deletebankaccount,updatebankaccount}=accounts;
...
usersv2Router.put('/api/v2/accounts/:accountnumber',updatebankaccount);
